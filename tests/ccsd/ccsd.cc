...
bool test_energy2() {
  ...
  auto energy = wdt.contract(1, {opH2oovv, opT2}, 0, 0);
...
bool test_energy3() {
  ...
  auto energy = wdt.contract(scalar_t(1, 2), {opH2oovv, opT1, opT1}, 0, 0);
  auto energy_test =
...
int main(int argc, const char *argv[]) {
  ...
  auto test_functions = {
      ...
      std::make_tuple(TestPass, test_energy1, "CCSD Energy 1"),
      std::make_tuple(TestPass, test_energy2, "CCSD Energy 2"),
      std::make_tuple(TestPass, test_energy3, "CCSD Energy 3"),
  };
